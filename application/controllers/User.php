    ...
    public function insert() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($photo !== "") {
                ...
                $config['file_name'] = 'photo'.date('Ymd_his_') . rand(10, 99) . rand(10, 99) . rand(10, 99);
             ...
             /* Uploading NID Front Images */
             //$imagePath = realpath(APPPATH . '../assets/images/nid/');
             $nidfrontpage = $_FILES['nidfrontpage']['tmp_name'];
             if ($nidfrontpage !== "") {
                 $config['upload_path'] = $imagePath;
                 $config['allowed_types'] = 'jpg|png|jpeg|gif';
                 $config['file_name'] = 'nidfront'.date('Ymd_his_') . rand(10, 99) . rand(10, 99) . rand(10, 99);
                 $this->load->library('upload', $config);
                 if ($this->upload->do_upload('nidfrontpage')) {
                     $uploadData = $this->upload->data();
                     $data['nidfrontpage'] = $uploadData['file_name'];
                 }
             ...
             /* Uploading NID Back Images */
            //  $imagePath = realpath(APPPATH . '../assets/images/');
            //  $nidbackpage = $_FILES['nidbackpage']['tmp_name'];
            //  if ($nidbackpage !== "") {
            //      $config['upload_path'] = $imagePath;
            //      $config['allowed_types'] = 'jpg|png|jpeg|gif';
            //      $config['file_name'] = date('Ymd_his_') . rand(10, 99) . rand(10, 99) . rand(10, 99);
            //      $this->load->library('upload', $config);
            //      if ($this->upload->do_upload('nidbackpage')) {
            //          $uploadData = $this->upload->data();
            //          $data['nidbackpage'] = $uploadData['file_name'];
            //      }
            ...
            $data['nidno'] = $this->input->post('nidno');
